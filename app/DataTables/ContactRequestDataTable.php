...
class ContactRequestDataTable extends DataTable
{
    ...
    public function dataTable(QueryBuilder $query): EloquentDataTable
    {
        ...
        return (new EloquentDataTable($query))
            ->editColumn('user', function (ContactRequest $user) {
                return view('pages.contactRequest.columns._contactRequest', compact('user'));
            })
            ->addColumn('action', function (ContactRequest $user) {
                return view('pages.contactRequest.columns._actions', compact('user'));
            })
            ->setRowId('id');
    }
    ...
    {
        return $this->builder()
            ->setTableId('contact_requests-table')
