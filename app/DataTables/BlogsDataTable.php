...
class BlogsDataTable extends DataTable
{
    ...
    public function dataTable(QueryBuilder $query): EloquentDataTable
    {
        ...
        return (new EloquentDataTable($query))
            ->editColumn('user', function (Blog $user) {
                return view('pages.blogs.columns._blog', compact('user'));
            })
            ->addColumn('action', function (Blog $user) {
                return view('pages.blogs.columns._actions', compact('user'));
            })
            ->setRowId('id');
    }
